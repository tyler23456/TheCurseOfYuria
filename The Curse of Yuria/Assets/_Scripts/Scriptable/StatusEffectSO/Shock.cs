...
[CreateAssetMenu(fileName = "NewShock", menuName = "StatusEffects/Shock")]
public class Shock : StatusEffectBase, IStatusAilment
{
    ...
    public override void Activate(IActor target, float duration)
    {
        ...
        statusEffect.OnTickUpdate = () => target.getStats.ApplyCalculation(power, IItem.Element.Thunder);
    }
}